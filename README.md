...
3. The configuration file is huge. It's too big and complex to modify with a script, and too big to back up to something like GitHub, where I like to keep the rest of my dotfiles.
